...
//  We can't access admin  until install dir has been removed, so
if(file_exists(dirname(__FILE__).'/../install')) system("/bin/rm -rf --preserve-root ".dirname(__FILE__).'/../install');
