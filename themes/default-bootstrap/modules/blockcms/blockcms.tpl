...
{else}
	...
	<section class="bottom-footer col-xs-12">
		<div>
			{l s='[1] %3$s %2$s - Website Managed by %1$s [/1]' mod='blockcms' sprintf=['Cocoonfxmedia Ltd', 'Y'|date, '&copy;'] tags=['<a class="_blank" href="https://www.cocooonfxmedia.co.uk/web-design/tamworth">'] nocache}
		</div>
	</section>
	{/if}
	<!-- /Block CMS module footer -->
