        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
					...
					<div class="alert alert-info">'.sprintf($this->l('Your avatar is your profile picture on %1$s. To change your avatar, log in with your email %2$s and follow the on-screen instructions.'), '', $obj->email).'</div>',
                ),
                array(
                    'type' => 'text',
